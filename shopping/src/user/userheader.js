            ...
            <div className="container">
                ...
                <div className="collapse navbar-collapse" id="navbarTogglerDemo03">
                    <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item me-4">
                            <Link className="nav-link text-white" to="/login" ><i className="fa fa-lock"></i> Vender Login </Link>
                        </li>
                        <li className="nav-item me-4">
                            <Link className="nav-link text-white" to="/signup" ><i className="fa fa-user-plus"></i> New Vender </Link>
                        </li>
                    </ul>
                </div>
            </div>
